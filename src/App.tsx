...
function App() {
  ...
  return (
    ...
    >
      <div className="bg-amber-200 h-svh w-svw">
        {menuIsVisible && (
        ...
        <div className="flex h-full w-full justify-center">
          <div
            role="status"
            className="flex flex-col absolute justify-center items-center space-around h-full w-full"
          >
            <svg
              className="w-8 h-8 text-gray-200 animate-spin dark:text-amber-200 dark:fill-amber-700 fill-amber-700"
              viewBox="0 0 100 101"
              fill="none"
