...
function App() {
  return (
    <div className="bg-slate-800 h-svh w-svw">
      <div className="bg-white h-24 p-2 m-4 w-[5/6] absolute right-0 top-0 z-30 shadow-lg rounded-md">
        <div className="flex flex-col w-full justify-center items-center">
          <h1 className="text-3xl text-red-600 font-sixtyfour">ArchiMap</h1>
