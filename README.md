...
React, Vite, Bun, Express et Tailwind sont parmis les meilleurs choix pour un projet d'une page interactif et avec un backend très limité. Typescript est pensé pour faciliter la gestion des types de données issus des API.
